...
onMounted(async () => { try { const r = await api.get('/api/profile'); if (r.data.code === 200) { p.value = r.data.data; sf.q1 = r.data.data.question1; sf.q2 = r.data.data.question2 } } catch (e) { console.error('加载个人信息失败:', e) } })
